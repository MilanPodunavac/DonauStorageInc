...
export const AddressDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="donauStorageIncApp.address.delete.question">
        <Translate contentKey="donauStorageIncApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
