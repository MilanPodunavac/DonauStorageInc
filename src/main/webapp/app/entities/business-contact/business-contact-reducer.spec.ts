...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSINESSCONTACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUSINESSCONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUSINESSCONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUSINESSCONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUSINESSCONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUSINESSCONTACT actions', async () => {
      const expectedActions = [
        {
