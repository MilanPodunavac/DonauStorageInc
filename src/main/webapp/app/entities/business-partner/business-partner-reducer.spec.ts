...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSINESSPARTNER_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUSINESSPARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUSINESSPARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUSINESSPARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUSINESSPARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUSINESSPARTNER actions', async () => {
      const expectedActions = [
        {
