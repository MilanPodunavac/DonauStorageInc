...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSINESSYEAR_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUSINESSYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUSINESSYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUSINESSYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUSINESSYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUSINESSYEAR actions', async () => {
      const expectedActions = [
        {
