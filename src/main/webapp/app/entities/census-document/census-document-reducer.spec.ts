...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENSUSDOCUMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CENSUSDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CENSUSDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CENSUSDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CENSUSDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CENSUSDOCUMENT actions', async () => {
      const expectedActions = [
        {
