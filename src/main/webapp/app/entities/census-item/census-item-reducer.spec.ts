...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENSUSITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CENSUSITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CENSUSITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CENSUSITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CENSUSITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CENSUSITEM actions', async () => {
      const expectedActions = [
        {
