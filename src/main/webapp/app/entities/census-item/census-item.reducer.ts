...
const apiUrl = 'api/xt/census-items';

// Actions

export const getEntities = createAsyncThunk('censusItem/fetch_entity_list', async ({ query, page, size, sort }: IQueryParams) => {
  const requestUrl = `${apiUrl}?${query ? `censusDocumentId.equals=${query}&` : ''}${
