  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="donauStorageIncApp.city.home.createOrEditLabel" data-cy="CityCreateUpdateHeading">
            <Translate contentKey="donauStorageIncApp.city.home.createOrEditLabel">Create or edit a City</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('donauStorageIncApp.city.name')}
                id="city-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('donauStorageIncApp.city.postalCode')}
                id="city-postalCode"
                name="postalCode"
                data-cy="postalCode"
                type="text"
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('donauStorageIncApp.city.country')}
                type="select"
                required
              >
                <option value="" key="0" />
