...
export const CompanyDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="donauStorageIncApp.company.delete.question">
        <Translate contentKey="donauStorageIncApp.company.delete.question" interpolate={{ id: companyEntity.id }}>
