...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="donauStorageIncApp.country.delete.question">
        <Translate contentKey="donauStorageIncApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
