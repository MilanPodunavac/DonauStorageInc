...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="donauStorageIncApp.employee.delete.question">
        <Translate contentKey="donauStorageIncApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
