  ...
  return (
    <div>
      <h2 id="employee-heading" data-cy="EmployeeHeading">
        <Translate contentKey="donauStorageIncApp.employee.home.title">Employees</Translate>
        {chosenCompany.id != 0 && (
          <div className="d-flex justify-content-end">
            <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
              <FontAwesomeIcon icon="sync" spin={loading} />{' '}
              <Translate contentKey="donauStorageIncApp.employee.home.refreshListLabel">Refresh List</Translate>
            </Button>
            <Link to="/employee/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
              <FontAwesomeIcon icon="plus" />
              &nbsp;
              <Translate contentKey="donauStorageIncApp.employee.home.createLabel">Create new Employee</Translate>
            </Link>
          </div>
        )}
      </h2>
      <div className="table-responsive">
        {employeeList && employeeList.length > 0 && chosenCompany.id != 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('disability')}>
                  <Translate contentKey="donauStorageIncApp.employee.disability">Disability</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('employment')}>
                  <Translate contentKey="donauStorageIncApp.employee.employment">Employment</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="donauStorageIncApp.employee.home.notFound">No Employees found</Translate>
            </div>
          )
        ) : (
          <div className="alert alert-warning">
            <Translate contentKey="donauStorageIncApp.employee.home.noBusinessYearChosen">No Business Year Chosen</Translate>
          </div>
        )}
      </div>
      {totalItems ? (
