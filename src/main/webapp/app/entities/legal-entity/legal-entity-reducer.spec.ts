...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEGALENTITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEGALENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEGALENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEGALENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEGALENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEGALENTITY actions', async () => {
      const expectedActions = [
        {
