...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEASUREMENTUNIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEASUREMENTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEASUREMENTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEASUREMENTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEASUREMENTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEASUREMENTUNIT actions', async () => {
      const expectedActions = [
        {
