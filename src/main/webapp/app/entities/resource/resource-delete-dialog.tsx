...
export const ResourceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="donauStorageIncApp.resource.delete.question">
        <Translate contentKey="donauStorageIncApp.resource.delete.question" interpolate={{ id: resourceEntity.id }}>
