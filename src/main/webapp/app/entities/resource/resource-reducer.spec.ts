...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './resource.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESOURCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESOURCE actions', async () => {
      const expectedActions = [
        {
