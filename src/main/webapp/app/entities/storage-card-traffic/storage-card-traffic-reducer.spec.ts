...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './storage-card-traffic.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORAGECARDTRAFFIC_LIST actions', async () => {
    ...
    it('dispatches FETCH_STORAGECARDTRAFFIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STORAGECARDTRAFFIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STORAGECARDTRAFFIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STORAGECARDTRAFFIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STORAGECARDTRAFFIC actions', async () => {
      const expectedActions = [
        {
