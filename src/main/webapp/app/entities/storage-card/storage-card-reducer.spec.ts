...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORAGECARD_LIST actions', async () => {
    ...
    it('dispatches FETCH_STORAGECARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STORAGECARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STORAGECARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STORAGECARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STORAGECARD actions', async () => {
      const expectedActions = [
        {
