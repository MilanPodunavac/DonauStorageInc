...
export const StorageDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="donauStorageIncApp.storage.delete.question">
        <Translate contentKey="donauStorageIncApp.storage.delete.question" interpolate={{ id: storageEntity.id }}>
