...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transfer-document-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSFERDOCUMENTITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSFERDOCUMENTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSFERDOCUMENTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSFERDOCUMENTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSFERDOCUMENTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSFERDOCUMENTITEM actions', async () => {
      const expectedActions = [
        {
