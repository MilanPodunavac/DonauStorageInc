...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transfer-document.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSFERDOCUMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSFERDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSFERDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSFERDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSFERDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSFERDOCUMENT actions', async () => {
      const expectedActions = [
        {
